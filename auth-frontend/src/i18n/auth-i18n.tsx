...
const messages = {
  zh: {
    ...
    'account.editNameTitle': '编辑用户名',
    'account.editNameLabel': '用户名：',
    'account.editNamePlaceholder': '请输入用户名',
    'account.school': '学校',
    'account.editSchool': '编辑学校',
    'account.region': '地区信息',
    'account.editRegion': '编辑地区',
    'account.editRegionTitle': '编辑地区',
    'account.country': '国家：',
    'account.province': '省份：',
    'account.city': '城市：',
    'account.district': '区县：',
    'account.regionPlaceholder': '请选择',
    'account.editSchoolTitle': '编辑学校',
    'account.schoolName': '学校名称',
    'account.schoolPlaceholder': '请输入学校名称',
    'account.confirm': '确认',
    'account.cancel': '取消',
    ...
    'account.changePasswordTitle': '更改密码',
    'account.changePasswordPhone': '请输入手机号：',
    'account.changePasswordCode': '验证码',
    'account.changePasswordSendCode': '发送验证',
    'account.changePasswordNext': '下一步',
    'account.changePasswordNextLoading': '验证中...',
    'account.changePasswordNewPassword': '新密码',
    'account.changePasswordNewPasswordPlaceholder': '请输入新密码',
    'account.changePasswordConfirm': '确认新密码',
    'account.changePasswordConfirmPlaceholder': '请再次输入新密码',
    'account.changePasswordSubmit': '确认修改',
    'account.changePasswordSubmitting': '修改中...',
    'account.changePasswordSuccess': '密码修改成功',
    'account.phoneBound': '已绑定 {phone}',
    'account.saveSuccess': '保存成功',
    'account.sendCodeRetry': '{seconds}s 后重试',
    'account.memory': '记忆',
  ...
  en: {
    ...
    'account.editNameTitle': 'Edit Username',
    'account.editNameLabel': 'Username:',
    'account.editNamePlaceholder': 'Enter username',
    'account.school': 'School',
    'account.editSchool': 'Edit',
    'account.region': 'Region',
    'account.editRegion': 'Edit',
    'account.editRegionTitle': 'Edit Region',
    'account.country': 'Country:',
    'account.province': 'Province:',
    'account.city': 'City:',
    'account.district': 'District:',
    'account.regionPlaceholder': 'Please select',
    'account.editSchoolTitle': 'Edit School',
    'account.schoolName': 'School Name',
    'account.schoolPlaceholder': 'Enter school name',
    ...
    'account.changePasswordPhone': 'Phone number:',
    'account.changePasswordCode': 'Verification code',
    'account.changePasswordSendCode': 'Send code',
    'account.changePasswordNext': 'Next step',
    'account.changePasswordNextLoading': 'Verifying...',
    'account.changePasswordNewPassword': 'New password',
    'account.changePasswordNewPasswordPlaceholder': 'Enter new password',
    'account.changePasswordConfirm': 'Confirm password',
    'account.changePasswordConfirmPlaceholder': 'Re-enter new password',
    'account.changePasswordSubmit': 'Confirm change',
    'account.changePasswordSubmitting': 'Changing...',
    'account.changePasswordSuccess': 'Password changed',
    'account.phoneBound': 'Bound: {phone}',
    'account.saveSuccess': 'Saved',
    'account.sendCodeRetry': 'Retry in {seconds}s',
